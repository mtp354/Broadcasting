...
The hardware data comprise 25 distinct broadcasting jobs containing 1581 per-angle, per-delay joint fidelity-register histograms, and five distinct standalone memory jobs. Duplicate observations are counted once, while separate cases within a job remain distinct. Counts are analyzed separately for each job, case, angle tuple, and delay.
